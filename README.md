# utl_calculating_rolling_3_month_skewness_of_prices_by_stock
utl_calculating_rolling_3_month_skewness_of_stock_prices_by_stock.Keywords: sas sql join merge big data analytics macros oracle teradata mysql sas communities stackoverflow statistics artificial inteligence AI Python R Java Javascript WPS Matlab SPSS Scala Perl C C# Excel MS Access JSON graphics maps NLP natural language processing machine learning igraph DOSUBL DOW loop stackoverflow SAS community.
    ...
    Much mor edifficult that I expected.
    ...
    Different skewness formula R, SPSS, MINTAB, BMDP and SAS
    ==============================================================
    ...
    ===========================================================================================
     ...
     Obs    STOCK         OPEN    |   RULES                   WANT
       ...
       1    IBM           84.50   |                           .
       2    IBM          113.62   |                           .
       3    IBM          103.62   |   84.50+113.62+103.62     301.74   rolling sum of first 3 months
       4    IBM          101.00   |                           318.24
       5    IBM          122.87   |                           327.49
                                  |
       6    Intel         33.33   |
    ...
    * compute SAS skewness using R type2;
    %utl_submit_r64('
    library(e1071);
    x<-c(84.50 ,113.62 ,103.62);
    skewness(x, na.rm = FALSE, type = 2);
    x<-c(31.90,27.56,77.62);
    skewness(x, na.rm = FALSE, type = 2);
    ');

    [1] -0.3615194   ( R)

    [1] -0.8855382   (SAS and SPSS)     type 2
    ...
    Obs    STOCK         OPEN     SAS
      ...
      1    IBM           84.50
      2    IBM          113.62
      3    IBM          103.62 -0.88554  checks with R type 2
      4    IBM          101.00  1.43540
      5    IBM          122.87  1.63874
      6    Intel         33.33   .
      7    Intel         31.90   .
      8    Intel         27.56  1.30129
      9    Intel         77.62  1.68446  checks with R type 2
     10    Intel        105.81  0.79975
